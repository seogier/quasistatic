...
if __name__=='__main__':
    ...
    parser.add_argument('-r', '--radius', type=float, help='Radius of loop in m')
    parser.add_argument('-l', '--length', type=float, help='Length of line in m')
    parser.add_argument('-s', '--segments', type=int, help='Number of segments to discritize coil')
    parser.add_argument('-z', '--z-offset', type=float, help = 'Z offset of coil from XY plane', default=0.0)
